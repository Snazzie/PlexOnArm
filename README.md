...
- **Optimized Performance**: Built with Tauri for minimal resource usage and fast startup times. No Skipping on windows arm devices.
- **Smaller Bundle**: 17MB vs 180MB executable
